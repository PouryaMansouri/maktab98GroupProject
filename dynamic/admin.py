...
class PageDataAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (
            (None,
             {
                'fields': ('name','target_name','title',('banner','banner_preview'),'route','footer')
            }
            ),
    )
    )
...
class FooterAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (
            (None,
             {
                'fields': ('footer_name','footer_phone',('footer_logo','logo_preview'),'footer_email','footer_text')
            }
            ),
            ...
            ('Social Links', 
             {
                ...
                'fields': ('footer_youtube','footer_telegram','footer_instagram','footer_googleplus','footer_twitter'),
            }
        )
    )
    )
